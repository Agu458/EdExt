...
public class AltaCategoria extends javax.swing.JInternalFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (!jTextField5.getText().equals("")) {
            if (Principal.is.validarNombreCategoria(jTextField5.getText())) {
                String nombre = this.jTextField5.getText();
                Principal.is.altaCategoria(nombre);
                JOptionPane.showMessageDialog(this, "Categoria Creada.", "Exito", JOptionPane.INFORMATION_MESSAGE);
                this.dispose();
            } else {
