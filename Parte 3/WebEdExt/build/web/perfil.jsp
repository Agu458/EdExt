                                ...
                                <div class="form-group p-4">
                                    <div class="list-group" id="ediciones">
                                        <form action="Edicion" method="GET">
                                            ...
                                            %>
                                            <button type="submit" class="list-group-item list-group-item-action list-group-item-success" name="consultarInscripcionEdicion" value="<%= edicion.getEstudiante()%>,<%= edicion.getEdicion().getNombre()%>,<%= edicion.getEdicion().getCurso() %>" > <%= edicion.getEdicion().getNombre()%> </button>
                                            <%
                                            } else {
                                                if (edicion.getEstado() == EstadoInscripcion.RECHASADO) {
                                            %>
                                            <button type="submit" class="list-group-item list-group-item-action list-group-item-danger" name="consultarInscripcionEdicion" value="<%= edicion.getEstudiante()%>,<%= edicion.getEdicion().getNombre()%>,<%= edicion.getEdicion().getCurso() %>" > <%= edicion.getEdicion().getNombre()%> </button>
                                            <%
                                            } else {
                                            %>
                                            <button type="submit" class="list-group-item list-group-item-action list-group-item-primary" name="consultarInscripcionEdicion" value="<%= edicion.getEstudiante()%>,<%= edicion.getEdicion().getNombre()%>,<%= edicion.getEdicion().getCurso() %>" > <%= edicion.getEdicion().getNombre()%> </button>
                                            <%
                                                        }
                                                    }
                                                }
