...
public class Calificacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String estudiante = request.getParameter("email");
        String calificacion = request.getParameter("calificacion");
        port.calificarEstudiante(estudiante, curso, edicion, new Float(calificacion));
        response.sendRedirect("Edicion?ingresarResultados="+curso+","+edicion);
    }
